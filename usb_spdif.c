...
static usb_spdif_tx_ready_handler_t usb_spdif_tx_ready_handler = NULL;
...
void usb_spdif_set_tx_ready_handler(usb_spdif_tx_ready_handler_t handler)
{
  usb_spdif_tx_ready_handler = handler;
}

uint16_t usb_spdif_write(const void * data, uint16_t len)
{
